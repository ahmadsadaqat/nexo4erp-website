      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal>
          <div className="max-w-4xl mx-auto text-center mb-16">
             ...
             <div className="text-lg text-gray-600 dark:text-gray-300 space-y-4 leading-relaxed text-left md:text-center">
               <p>
        ...
        <ScrollReveal delay={200}>
          <div className="mb-20">
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-6 text-center">At a Glance</h4>
              <div className="flex flex-wrap justify-center gap-4">
                  {['Integrated modules', 'Real-time dashboards', 'Modular scalability', 'Implementation support', 'Secure & compliant', 'Cloud-ready architecture'].map((item, i) => (
        ...
        <div ref={sectionRef} className="mb-24 relative">
             ...
             <ScrollReveal>
                <h4 className="text-2xl font-bold text-gray-900 dark:text-white mb-12 text-center relative z-10 bg-gray-50 dark:bg-black inline-block px-4 mx-auto block">Our Journey</h4>
             </ScrollReveal>
             ...
             <div className="space-y-12">
                 ...
                 <div className={`flex flex-col md:flex-row items-center justify-between gap-8 relative z-10 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                     ...
                     <div className="flex-1 order-2 md:order-3">
                         <h5 className="text-xl font-bold text-gray-900 dark:text-white">Oct 2025: The Pivot</h5>
                         <p className="text-gray-600 dark:text-gray-400 mt-2">Transitioned to a SaaS model, launching the core NEXO ERP cloud platform, bringing ERP to businesses anywhere, anytime.</p>
                     </div>
                 </div>
                 ...
                 <div className={`flex flex-col md:flex-row items-center justify-between gap-8 relative z-10 transition-all duration-700 delay-[1500ms] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                     ...
                     <div className="flex-1 order-2 md:order-3">
                         <h5 className="text-xl font-bold text-gray-900 dark:text-white">Dec 2025: Empowering Businesses</h5>
                         <p className="text-gray-600 dark:text-gray-400 mt-2">Started onboarding clients with customized workflows, boosting efficiency and accuracy across operations.</p>
                     </div>
                 </div>
             </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <ScrollReveal delay={100}>
            <div className="h-full bg-white/50 dark:bg-zinc-900/50 p-8 rounded-2xl border border-gray-100 dark:border-zinc-800 backdrop-blur-sm hover:border-primary-200 dark:hover:border-primary-900/30 transition-colors group">
          ...
          <ScrollReveal delay={300}>
            <div className="h-full bg-white/50 dark:bg-zinc-900/50 p-8 rounded-2xl border border-gray-100 dark:border-zinc-800 backdrop-blur-sm hover:border-primary-200 dark:hover:border-primary-900/30 transition-colors">
               <div className="w-12 h-12 bg-primary-100 dark:bg-primary-900/20 rounded-xl flex items-center justify-center mb-4 text-primary-600 dark:text-primary-400">
        ...
        <div className="mb-20">
            <ScrollReveal>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-10 text-center">Why Choose NEXO ERP?</h3>
            </ScrollReveal>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                    ...
                    { 
                        ...
                        desc: "From onboarding to daily operations, we’re with you every step.", 
                        icon: HeartHandshake,
                    ...
                    <ScrollReveal key={index} delay={index * 50}>
                      <div className="flex flex-col items-start p-6 rounded-xl bg-gray-50/50 dark:bg-zinc-900/30 hover:bg-white dark:hover:bg-zinc-800 transition-colors border border-transparent hover:border-gray-100 dark:hover:border-zinc-700 h-full group cursor-default">
        ...
        <ScrollReveal>
          <div className="text-center bg-primary-600 dark:bg-primary-900/20 rounded-3xl p-10 md:p-16 relative overflow-hidden">
               ...
               <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 relative z-10">Built for clarity, designed for growth.</h3>
