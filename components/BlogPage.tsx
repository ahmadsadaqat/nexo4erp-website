...
const BlogPage: React.FC<BlogPageProps> = ({
  ...
  const filteredPosts =
    filter === 'All' ? blogs : blogs.filter((p) => p.category === filter)
              ...
              {blogs
                ...
                .map((post) => (
                  <div
                    ...
                    className='bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md p-8 rounded-3xl shadow-sm hover:shadow-2xl transition-all cursor-pointer group border border-transparent hover:border-primary-500/20'
                  >
                    <span className='text-[10px] font-black text-primary-600 dark:text-primary-400 uppercase tracking-widest mb-4 block'>
                      {post.category}
                    </span>
                    <h4 className='text-xl font-bold text-gray-900 dark:text-white group-hover:text-primary-600 transition-colors mb-6 leading-tight'>
                      {post.title}
                    </h4>
                ...
                >
                  <div className='relative h-64 overflow-hidden'>
                    ...
                    <div className='absolute top-6 left-6'>
                      <span className='px-4 py-2 bg-white/95 backdrop-blur-md text-primary-700 text-[10px] font-black uppercase tracking-widest rounded-full shadow-xl border border-primary-500/10'>
                        {post.category}
                      </span>
                    </div>
                  </div>
                  <div className='p-10 flex flex-col flex-grow'>
                    ...
                    <h2 className='text-2xl font-black text-gray-900 dark:text-white mb-6 leading-[1.2] group-hover:text-primary-600 transition-colors'>
                      {post.title}
                    </h2>
                    <p className='text-gray-500 dark:text-gray-400 text-sm leading-relaxed mb-10 flex-grow line-clamp-3'>
                      {post.excerpt}
                    </p>
