...
export default function EfficiencyAuditPage() {
  return (
    <div style={{padding: '2rem', minHeight: '100vh', display: 'flex', flexDirection: 'column'}}>
      ...
      <div style={{flex: 1, minHeight: 600, border: '1px solid #e6e6e6', borderRadius: 8, overflow: 'hidden'}}>
        <iframe
          src={EXTERNAL_URL}
          title="Efficiency Audit"
      ...
      <p style={{marginTop: '1rem', fontSize: 14}}>
        If the form doesn't load, <a href={EXTERNAL_URL} target="_blank" rel="noreferrer">open it in a new tab</a>.
      </p>
    </div>
  )
}
